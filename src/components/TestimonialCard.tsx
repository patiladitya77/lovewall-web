...
type TestimonialCardProps = {
  ...
  onLikeToggle?: (id: string, newLikeState: boolean) => void;
};
...
const TestimonialCard = ({
  ...
  const handleLikeTestimonial = () => {
    const newLikeState = !like;
    setLike(newLikeState); // update UI

    // notify parent
    if (onLikeToggle) {
      onLikeToggle(_id, newLikeState);
    }
  };
    ...
    <>
      ...
      <div className="bg-base-100 rounded-md p-4 my-4 ">
        <div className="flex justify-between">
          ...
          <div onClick={handleLikeTestimonial}>
            {like ? (
              <svg
